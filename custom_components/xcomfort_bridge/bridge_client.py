...
COMPONENT_MODELS = {
    2: "2-channel pushbutton",
    3: "4-channel pushbutton",
    74: "Switch actuator",
    77: "Dimmer actuator",
    78: "RC Touch",
    86: "Shading actuator",
...
class XComfortBridgeClient:
    ...
    def _handle_set_all_data(self, payload: dict[str, Any]) -> None:
        ...
        if payload.get("lastItem"):
            _LOGGER.debug(
                "Initial data complete: %d devices, %d components, %d rooms, %d slaves",
                len(self._devices), len(self._components),
                len(self._rooms), len(self._slave_bridges),
            )
